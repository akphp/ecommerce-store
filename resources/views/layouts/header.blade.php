                                 ...
                                 <i class="fa fa-angle-down"></i>
                                  @endif      
                                    ...
                                    @foreach ($category['children'] as $parent)
                                            <li>
                                                <a href="{{ route('products' , $parent['id'] ) }}">  {{ $parent['name_'.app()->getLocale()] ??  $parent['name'] }}  
                                            ...
                                            @if($parent['children'] != null)
                                            <ul class="ht-dropdown mndrop elementskit-dropdown">
                                                @foreach ($parent['children'] as $pp)
                                                        <li>
                                                            <a href="{{ route('products' , $pp['id'] ) }}">  {{ $pp['name_'.app()->getLocale()] ??  $pp['name'] }}  
